...
function priority(g,d){if(has(d))return{text:"● Dispatched",cls:"p-green"};if(g===null)return{text:"● No NBD",cls:"p-gray"};if(g>0)return{text:"● Overdue",cls:"p-red"};if(g>=-5)return{text:"● Due ≤5d",cls:"p-orange"};return{text:"● On Track",cls:"p-green"}}
