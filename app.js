...
function init(){
  ...
  document.getElementById('importPendingBody').innerHTML='<tr><td colspan="13" class="empty">Click Google Sheet to load SAE data</td></tr>';
